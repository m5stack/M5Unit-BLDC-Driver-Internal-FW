...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(DRV_FR_GPIO_Port, DRV_FR_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = DRV_FR_Pin|DRV_FS_Pin;
  ...
  GPIO_InitStruct.Pin = DRV_RD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(DRV_RD_GPIO_Port, &GPIO_InitStruct);
